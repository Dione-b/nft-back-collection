...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Hulk", "Thor", "Pantera_Negra", "Mercurio", "Nevasca", "Wanda"];
  string[] secondWords = ["Homem_Aranha", "Noturno", "Polaris", "Gambit", "Vampira", "Ciclope"];
  string[] thirdWords = ["Glactus", "Loki", "Electro", "Rino", "Surtur", "Thanos"];
  event NewEpicNFTMinted(address sender, uint256 tokenId);

  constructor() ERC721 ("Marvels Hero Vilain", "MHV") {
  ...
  function makeAnEpicNFT() public {
    ...
    // Incrementar o contador para quando o próximo NFT for cunhado
    _tokenIds.increment();

    // Incrementa o total quando o próximo for cunhado
